    ...
    public partial class CityServicesWorkproviderUpdateSystem : GameSystemBase
    {
        ...
        private void UpdateCityServicesWorkplace()
        {
            UpdateCityServicesWorkproviderJob updateCityServicesJob = new UpdateCityServicesWorkproviderJob
            {
                ...
                ParkingFacilityLookup = SystemAPI.GetComponentLookup<Game.Buildings.ParkingFacility>(true),
                ParkingFacilityDataLookup = SystemAPI.GetComponentLookup<ParkingFacilityData>(true),
                zero_park_and_parking_workers = Mod.m_Setting.zero_park_and_parking_workers,
